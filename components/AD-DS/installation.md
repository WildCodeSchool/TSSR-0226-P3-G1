...
![role](AD-DS/Ressources/ad-ds1.png)
...
![foret](AD-DS/Ressources/ad-ds2.png)
...
![password](AD-DS/Ressources/gpo-password.png)

-Restriction d'installation de logiciel pour les utilisateurs:

![Restriction](AD-DS/Ressources/gpo-logicielrestriction.png)

-Blocage de l'accès à la base de registre:

![registry](AD-DS/Ressources/gpo-registryblock.png)

-Blocage complet ou partiel au panneau de configuration:

![controlpanel](AD-DS/Ressources/gpo-controlpanel.png)

-Restriction des périphériques amovible:

![peripheriques](AD-DS/Ressources/gpo-devicerestriction.png)

ainsi que:

![peripheriques2](AD-DS/Ressources/gpo-devicerestriction-2.png)

-Gestion du pare-feu:

![FW](AD-DS/Ressources/gpo-FW-lvl1.png)
...
![RDP](AD-DS/Ressources/gpo-rdp.png)

mais aussi avec des logs

![RDP2](AD-DS/Ressources/gpo-rdp-2.png)

-Limitation des tentatives d'élévation de privilèges:

![credential](AD-DS/Ressources/gpo-limitationcredential.png)

-Politique de sécurité PowerShell:

![PS](AD-DS/Ressources/gpo-powershell.png)

### Les GPO Standards

-Mappage de lecteurs:

![lecteurs](AD-DS/Ressources/mappage-lecteur.png)

-Gestion de l'alimentation:

![alimentation](AD-DS/Ressources/gpo-powermanagement.png)

-Fond d'écran:

![wallpaper](AD-DS/Ressources/wallpaper.png)
